...
public class MySQLNew {
    ...
    private static MultiMySQLConnection msyqlVersion = new MultiMySQLConnection();

    // โหลดการตั้งค่าจาก properties ไฟล์
    static {
        try (InputStream fis = new FileInputStream("db_new_config.properties")) {
    ...
    public static Connection getConnection(String dbVersion, String dbHost, String dbPort, String dbUser, String dbPass, String dbName) throws SQLException, ClassNotFoundException {
