        ...
        <Box sx={{ ...modalStyle, padding: "10px", width: "450px", background: "none" }}>
            <Grid2 container spacing={1} justifyContent="space-between">
                <Grid2 size={4} container direction="column" alignItems="center" sx={panelStyle}>
                    ...
                    <Button variant='text' sx={{ color: "white" }}>Company</Button>
                </Grid2>
                <Grid2 size={4} container direction="column" alignItems="center" sx={panelStyle}>
                    <StoreIcon sx={{ color: "white" }} fontSize='large' />
                    <Button variant='text' sx={{ color: "white" }}>Branch</Button>
                </Grid2>
                <Grid2 size={4} container direction="column" alignItems="center" sx={panelStyle}>
                    <StoreIcon sx={{ color: "white" }} fontSize='large' />
                    <Button variant='text' sx={{ color: "white" }}>Shop</Button>
                </Grid2>
                <Grid2 size={4} container direction="column" alignItems="center" sx={panelStyle}>
                    <PointOfSaleIcon sx={{ color: "white" }} fontSize='large' />
                    <Button variant='text' sx={{ color: "white" }}>Terminal</Button>
                </Grid2>
                <Grid2 size={4} container direction="column" alignItems="center" sx={panelStyle}>
                    <GroupIcon sx={{ color: "white" }} fontSize='large' />
                    <Button variant='text' sx={{ color: "white" }}>Employee</Button>
                </Grid2>
                <Grid2 size={4} container direction="column" alignItems="center" sx={panelStyle}>
