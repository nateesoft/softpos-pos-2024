...
const HourlyPluReportModal = ({ setOpen }) => {
  ...
  const handleConfirm = async () => {
    if (macno1 || macno2) {
      ...
      navigate(`/reportDaily/hourly-plu-report${query}`)
    }
  }
  ...
  return (
    <Box sx={{ ...modalStyle, padding: "20px", width: "450px" }}>
      <Grid2 container spacing={2} padding={2} justifyContent="center">
        <Typography variant="p" sx={{ fontWeight: "bold", fontSize: "16px" }}>รายงานการขายรายชั่วโมง</Typography>
      </Grid2>
...
export default HourlyPluReportModal
