...
const LeftMenu = memo(() => {
  ...
  return (
    ...
    >
      <div className="description" style={{ color: "#aaa" }}>
        TABLE LAYOUT
      </div>
      <Grid2 container spacing={1}>
        <Grid2 size={12}>
          <Box
            ...
            alignItems="center"
            sx={{ border: "2px solid", borderRadius: "50%", height: "110px" }}
        ...
        <Grid2 size={12}>
          <Box
            ...
            justifyContent="center"
            alignItems="center"
            sx={{ border: "2px solid", height: "110px" }}
        ...
        <Grid2 size={12}>
          <Box
            ...
            justifyContent="center"
            alignItems="center"
            sx={{ border: "2px solid", height: "50px" }}
            onDragStart={(event) => onDragStart(event, "long")}
            draggable
          >
        ...
        >
          <Box
            ...
            justifyContent="center"
            alignItems="center"
            sx={{ border: "2px solid", height: "110px", width: "50px" }}
            onDragStart={(event) => onDragStart(event, "tall")}
            draggable
          >
