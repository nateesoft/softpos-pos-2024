    ...
    <>
      ...
      >
        ...
        <MenuItem onClick={() => handleSelect("MEETING_ROOM")}>
          <Box display="flex" justifyContent="center">
            <MeetingIcon sx={{ marginRight: "10px" }} />{" "}
            <Typography variant="p">Meeting Room</Typography>
          </Box>
        </MenuItem>
        <MenuItem onClick={() => handleSelect("DINNING_ROOM")}>
          <Box display="flex" justifyContent="center">
            <DinnerDiningIcon sx={{ marginRight: "10px" }} />{" "}
            <Typography variant="p">Dinner Room</Typography>
          </Box>
        </MenuItem>
        <Divider />
        <MenuItem onClick={() => handleSelect("WARTER_BAR")}>
          <Box display="flex" justifyContent="center">
            <LocalBarIcon sx={{ marginRight: "10px" }} />{" "}
            <Typography variant="p">Warter Bar</Typography>
          </Box>
        </MenuItem>
      </Menu>
    </>
