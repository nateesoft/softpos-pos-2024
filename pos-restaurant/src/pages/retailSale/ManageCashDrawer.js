...
const ManageCashDrawer = ({ setOpen }) => {
  ...
  return (
    <Box sx={{ ...modalStyle, padding: "20px", width: "450px" }}>
      ...
      <CustomTabPanel value={value} index={0}>
        <TextField
          label="เงินสำรองทอน เข้าลิ้นชัก"
          type="number"
          value={inCash}
        ...
        <Grid2 container spacing={2} margin={2} justifyContent="center">
          ...
          <Button variant="contained" color="info" onClick={handleConfirmIn}>
            Confirm
          </Button>
        </Grid2>
      </CustomTabPanel>
      <CustomTabPanel value={value} index={1}>
        <Grid2 container spacing={2}>
          ...
          />
          <TextField
            label="เงินสำรองทอน ออกจากลิ้นชัก"
            type="number"
            value={outCash}
        ...
        <Grid2 container spacing={2} margin={2} justifyContent="center">
          ...
          <Button variant="contained" color="info" onClick={handleConfirmOut}>
            Confirm
          </Button>
        </Grid2>
      </CustomTabPanel>
...
export default ManageCashDrawer
