...
const updateBalance = async payload => {
    ...
    try {
        ...
        R_Price='${R_Price}',R_Total='${R_Total}',R_PrType='${R_PrType}',R_PrCode='${R_PrCode}',
        R_PrDisc='${R_PrDisc}',R_PrBath='${R_PrBath}',R_PrAmt='${R_PrAmt}',R_DiscBath='${R_DiscBath}',
