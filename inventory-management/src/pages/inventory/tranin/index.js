    ...
    <div style={{ marginTop: 60, overflow: "auto" }}>
      ...
      <Box marginBottom={1}>
        ...
        <Grid2 container direction="row" spacing={1}>
          <TextFieldCustom label="รับโอนจากสาขา" />
          <FindButton />
          <TextFieldCustom label="ชื่อสาขา (Branch Name)" />
        </Grid2>
      </Box>
      <Divider />
      <Box marginBottom={1}>
      ...
      >
        <MenuItem>สรุปการรับสินค้า (เข้า) ตามรหัสสินค้า</MenuItem>
        <MenuItem>สรุปการรับสินค้า (เข้า) ตามแผนกสินค้า</MenuItem>
      </Menu>
    </div>
  )
}

export default Tranin
