...
const columns = [
  { id: 'no', label: 'วันที่ (Date)', width: 80 },
  { id: 'pcode', label: 'คลัง', width: 100, align: 'center' },
  { id: 'pname', label: 'เลขที่เอกสาร (Doc-No)', width: 350, align: 'left' },
  { id: 'stk', label: 'หมายเหตุ', width: 100, align: 'center' },
  { id: 'qty', label: 'จำนวน(เข้า)', width: 100, align: 'right' },
  { id: 'unit', label: 'จำนวนเงิน', width: 100, align: 'center', format: (value) => value.toFixed(2) },
  { id: 'price', label: 'จำนวน(ออก)', width: 200, align: 'right', format: (value) => value.toFixed(2) },
  { id: 'amount', label: 'จำนวนเงิน', width: 200, align: 'right', format: (value) => value.toFixed(2) },
  { id: 'amount', label: 'ราคา/หน่วย', width: 200, align: 'right', format: (value) => value.toFixed(2) },
  { id: 'amount', label: 'หน่วยนับ', width: 200, align: 'right', format: (value) => value.toFixed(2) }
];
