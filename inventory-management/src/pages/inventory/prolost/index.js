    ...
    <div style={{ marginTop: 60, overflow: "auto" }}>
      <AppBar position="static" sx={{background: "green"}}>
        <Toolbar variant="dense">
          <Typography variant="h6">
            บันทึกรายการของเสีย และสินค้าชำรุด
          </Typography>
        </Toolbar>
      </AppBar>
      <Grid2
      ...
      <Box marginBottom={1}>
        <Grid2 container direction="row" spacing={1} marginBottom={1}>
          ...
          <FindButton />
          <TextFieldCustom label="วันที่บันทึก" />
          <TextField
            size="small"
            label="หมายเหตุ"
            inputProps={{
      ...
      <Box marginBottom={1}>
        <Table sx={{ margin: "1px" }}>
          <TableRow>
            ...
            <TableCell>
              <TextFieldCustom variant="standard" label="จากคลัง" />
            </TableCell>
            <TableCell>
              <FindButtonNoBorder />
            </TableCell>
      ...
      >
        <MenuItem>สรุปรายการบันทึกของเสีย & สินค้าชำรุด ตามรหัสสินค้า</MenuItem>
        <MenuItem>สรุปรายการบันทึกของเสีย & สินค้าชำรุด ตามแผนกสินค้า</MenuItem>
      </Menu>
    </div>
  )
}

export default Prolost
