    ...
    <div style={{ marginTop: 60, overflow: "auto" }}>
      ...
      <Box marginBottom={1}>
        ...
        <Grid2 container direction="row" spacing={1}>
          <TextFieldCustom label="โอนไปสาขา" />
          <FindButton />
      ...
      >
        <MenuItem>สรุปการรับสินค้า (ออก) ตามรหัสสินค้า</MenuItem>
        <MenuItem>สรุปการรับสินค้า (ออก) ตามแผนกสินค้า</MenuItem>
      </Menu>
    </div>
  )
}

export default Tranout
