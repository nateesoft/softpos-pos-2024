    ...
    <div style={{ marginTop: 60, overflow: "auto" }}>
      ...
      <Box marginBottom={1}>
        <Grid2 container direction="row" spacing={1} marginBottom={1}>
          ...
          <FindButton />
          <TextFieldCustom label="ประจำวันที่" />
          <TextField
            size="small"
            label="หมายเหตุ"
            inputProps={{
        ...
        <Grid2 container direction="row" spacing={1}>
          <TextFieldCustom label="สำหรับคลัง" />
          <FindButton />
          <TextFieldCustom label="คลังสินค้าหน้าร้าน" />
        </Grid2>
      </Box>
      <Divider />
      <Box marginBottom={1}>
        <Table sx={{ margin: "1px" }}>
          <TableRow>
            ...
            <TableCell>
              <TextFieldCustom variant="standard" label="จำนวนนับได้จริง" />
            </TableCell>
            <TableCell>
              <TextFieldCustom variant="standard" label="ราคา/หน่วย" />
            </TableCell>
            <TableCell>
              <TextFieldCustom variant="standard" label="หมายเหตุ" />
            </TableCell>
          </TableRow>
          <TableRow>
