...
const columns = [
  ...
  { id: 'pname', label: 'ชื่อสินค้า (Description)', width: 350, align: 'left' },
  { id: 'stk', label: 'กลุ่ม', width: 100, align: 'center' },
  { id: 'stk', label: 'ชื่อกลุ่ม', width: 100, align: 'center' },
  { id: 'stk', label: 'ผู้ขาย', width: 100, align: 'center' },
  { id: 'unit', label: 'หน่วยนับ', width: 100, align: 'center', format: (value) => value.toFixed(2) },
  { id: 'price', label: 'ราคา/หน่วย', width: 200, align: 'right', format: (value) => value.toFixed(2) },
  { id: 'amount', label: 'สถานะ', width: 200, align: 'right', format: (value) => value.toFixed(2) },
  { id: 'amount', label: 'ประเภท', width: 200, align: 'right', format: (value) => value.toFixed(2) },
  { id: 'amount', label: 'ให้ส่วนลด', width: 200, align: 'right', format: (value) => value.toFixed(2) },
  { id: 'amount', label: 'ทำสต็อก', width: 200, align: 'right', format: (value) => value.toFixed(2) },
  { id: 'amount', label: 'สินค้าชุด', width: 200, align: 'right', format: (value) => value.toFixed(2) },
  { id: 'amount', label: 'คิดภาษี', width: 200, align: 'right', format: (value) => value.toFixed(2) },
  { id: 'amount', label: 'ปริมาณสูงสุดในคลัง', width: 200, align: 'right', format: (value) => value.toFixed(2) },
  { id: 'amount', label: 'ปริมาณต่ำสุดในคลัง', width: 200, align: 'right', format: (value) => value.toFixed(2) },
];
