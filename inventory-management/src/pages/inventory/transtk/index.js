    ...
    <div style={{ marginTop: 60, overflow: "auto" }}>
      <AppBar position="static" sx={{background: "green"}}>
        <Toolbar variant="dense">
          <Typography variant="h6">
            รายการโอนสินค้าระหว่างคลัง (Stock)
          </Typography>
        </Toolbar>
      </AppBar>
      <Grid2
      ...
      <Box marginBottom={1}>
        <Grid2 container direction="row" spacing={1} marginBottom={1}>
          ...
          <FindButton />
          <TextFieldCustom label="วันที่โอนสินค้า" />
          <TextField
            label="หมายเหตุ"
            inputProps={{
              style: {
        ...
        <Grid2 container direction="row" spacing={1}>
          <TextFieldCustom label="โอนจากคลัง" />
          <FindButton />
          <TextFieldCustom label="** คลังสินค้า **" />
          <TransferButton />
          <TextFieldCustom label="ไปยังคลัง" />
          <FindButton />
          <TextFieldCustom label="** คลังสินค้า **" />
        </Grid2>
      </Box>
      ...
      <Box marginBottom={1}>
        <Table sx={{ margin: "1px" }}>
          <TableRow>
            ...
            <TableCell>
              <TextFieldCustom variant="standard" label="ราคา/หน่วย" />
            </TableCell>
            <TableCell>
      ...
      >
        <MenuItem>สรุปการโอนสินค้าระหว่างคลัง (ตามรหัสสินค้า)</MenuItem>
      </Menu>
    </div>
  )
}

export default TranStk
